...
- Rust is the default entry (`scripts/cc-loop`, install path, Python CLI delegates); Python remains a fallback via `CC_LOOP_FORCE_PYTHON=1` — see [rust/docs/MIGRATION.md](rust/docs/MIGRATION.md)
