...
_EVENT_PHASE: dict[str, str] = {
    ...
    EventType.PATCH_CAPTURE_RECOVERED.value: "patch_capture",
    EventType.RECOVERY_SKIPPED.value: "recovery",
...
_EVENT_ACTION: dict[str, str] = {
    ...
    EventType.PATCH_CAPTURE_RECOVERED.value: "recovered",
    EventType.RECOVERY_SKIPPED.value: "skipped",
