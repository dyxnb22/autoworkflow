...
def plan_artifact_paths(artifact_root: Path) -> dict[str, Path]:
    ...
    return {
        ...
        "task_context": artifact_root / "task.context.json",
        ...
        "review_fast_prompt": artifact_root / "review.fast.prompt.txt",
        "review_fast_parsed": artifact_root / "review.fast.parsed.json",
        "review_fast_prompt_metrics": artifact_root / "review.fast.prompt.metrics.json",
        "review_fast_raw": artifact_root / "review.fast.raw.jsonl",
        "review_fast_last_message": artifact_root / "review.fast.last-message.txt",
        "review_fast_provider": artifact_root / "review.fast.provider.txt",
